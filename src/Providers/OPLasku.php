...
class OPLasku
{
    ...
    public function register_scripts()
    {
        ...
        wp_register_script('paytrail-op-lasku-helper', Plugin::plugin_url() . '/assets/op-lasku-assets/op-lasku-helper.js', array(), '1.0.0', true);
    ...
    {
        $this->cart_total = WC()->cart ? WC()->cart->get_total('') : 0;
