...
Contributors: loueranta, kotivuori
...
- Removed hardcoded script tags and now use official core APIs, allowing plugins to filter script attributes. Thanks to @oxyc for contributing this improvement!
