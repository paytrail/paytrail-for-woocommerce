...
const render = () => {
  ...
  const onCartChange = () => {
    const cart = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.select)(_woocommerce_block_data__WEBPACK_IMPORTED_MODULE_2__.CART_STORE_KEY).getCartData();
    if (!cart) {
      return;
    }
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    const unsubscribe = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.subscribe)(onCartChange);
    return () => {
      unsubscribe();
    };
  }, []);
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_woocommerce_blocks_checkout__WEBPACK_IMPORTED_MODULE_4__.ExperimentalOrderMeta, {
...
(0,_wordpress_plugins__WEBPACK_IMPORTED_MODULE_3__.registerPlugin)("paytrail-oplasku-cart-blocks", {
  render,
...
/******/ })()
;
//# sourceMappingURL=op-lasku-helper-blocks.js.map